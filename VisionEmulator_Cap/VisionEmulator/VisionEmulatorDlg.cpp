...
CVisionEmulatorDlg::CVisionEmulatorDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CVisionEmulatorDlg::IDD, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CVisionEmulatorDlg::DoDataExchange(CDataExchange* pDX)
{
...
// CVisionEmulatorDlg 메시지 처리기

BOOL CVisionEmulatorDlg::OnInitDialog()
{
...
void CVisionEmulatorDlg::OnPaint()
{
	if (IsIconic())
	{
...
//  이 함수를 호출합니다.
HCURSOR CVisionEmulatorDlg::OnQueryDragIcon()
{
